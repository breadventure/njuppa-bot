...
DEFAULT_PROMPT = """
🔧 ПРОМТ ДЛЯ СОСТАВЛЕНИЯ КОРЗИН (NJUPPA)
Задача:
...
Скидка: 60% (платится 40%), МИНИМАЛЬНАЯ ЦЕНА КОРЗИНЫ 1000 динаров
...
- Всегда писать остатки, которые не использованы

2. Минимальная цена корзины: 1000 RSD до скидки, скидка всегда 60% (40% оплата)

3. НЕЛЬЗЯ:
- добавлять позиции, которых нет
- превышать остатки
- делать корзины меньше 1000
- показывать расчёты и анализ — только финальные корзины!
- "додумывать" булки или менять названия

4. ЛОГИКА СБОРКИ
1. Сначала корзины с хлебом — тартин, семечковый, ржаной, фокачча и булками
2. Потом корзины с булками, если есть остаток
3. Потом корзины с хлебом, если много в остатке
4. Чередовать: сладкие / сладко-солёные / хлебные
5. Если в остатках много хлеба, то можно делать корзины 2 хлеба + булки

5. ФОРМАТ — строго так, без отклонений:
...
В конце ТОЛЬКО:
Остатки: Позиция: X, Позиция: X (или "Всё использовано")

ВАЖНО: только обычный текст и эмодзи. Без markdown, звёздочек, решёток, HTML тегов, таблиц и расчётов!
ВАЖНО: корзины, состав, описание, название всегда на сербской латинице, а все остальные заметки на русском.
Название корзин не больше 30 знаков.
"""
